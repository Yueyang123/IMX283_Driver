...
#define RST_PIN  2*32 + 14
#define PWDN_PIN 3*32 + 24
#define OV2640_MAX_CLK 24000000 // 24MHz

#define BIT_READ(x)          gpio_get_value(x) 
#define OV2640_RST(x)        gpio_set_value(RST_PIN,x)    //RST 
#define OV2640_PWDN(x)       gpio_set_value(PWDN_PIN,x) 
////////////////////////////////////////////////////////////////////////////////// 
